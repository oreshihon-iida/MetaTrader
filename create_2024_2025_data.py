...
logger.log_info("2024-2025年データ処理開始")
...
for year in [2024, 2025]:
    ...
    if year == 2025:
        ...
        zip_files = [f for f in os.listdir("data/raw") if f.endswith('.zip') and f"USDJPY_M1{year}.zip" in f]
...
logger.log_info("2024-2025年データ処理完了")
