...
# 日本語フォント設定（japanize-matplotlibを使用）
...
# 保存
plt.savefig('results/with_execution/monthly_performance_charts.png', dpi=150, bbox_inches='tight')
print("グラフを results/with_execution/monthly_performance_charts.png に保存しました")
