...
class DualStrategyManager:
    ...
    短期戦略と長期戦略のシグナルを統合し、総合的な取引戦略を提供する
    """
    
    def __init__(self, 
                short_term_strategy_params: Dict = None,
                long_term_strategy_params: Dict = None,
                max_short_term_positions: int = 2,
                max_long_term_positions: int = 1,
                short_term_capital_ratio: float = 0.3,
                long_term_capital_ratio: float = 0.7):
        """
        初期化
        ...
        long_term_strategy_params : Dict, default None
            長期戦略のパラメータ
        max_short_term_positions : int, default 2
            短期戦略の最大ポジション数
        max_long_term_positions : int, default 1
            長期戦略の最大ポジション数
        short_term_capital_ratio : float, default 0.3
            短期戦略に割り当てる資金の割合
        long_term_capital_ratio : float, default 0.7
            長期戦略に割り当てる資金の割合
        """
